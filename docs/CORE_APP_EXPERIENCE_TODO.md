...
- [x] Confirm every title card opens Series Detail reliably.
- [x] Confirm Forum referenced titles open Series Detail reliably.
...
- [x] Confirm detail page works when opened from Home, Search, Compare, and Forum.
...
- [x] Ensure compare and detail navigation work from search results.
